...
public class TemperatureSeriesAnalysisTest {
    ...
    public void testConstructorIfCopyInputArray() {
        double[] arg = {1, 2, -273.0, 0, 300};
        TemperatureSeriesAnalysis temperatureSeriesAnalysist = new
                TemperatureSeriesAnalysis(arg);
        arg[2] = 0;
    ...
    public void
    testConstructorThrowExceptionWhenTemperatureLessThanAbsoluteZero() {
    ...
    public void testAverageOfObjectConstructedWithoutArgsThrowsException() {
        TemperatureSeriesAnalysis temperatureSeriesAnalysis = new
    ...
    public void testAverageOfObjectConstructedOnEmptyArrayThrowsException() {
        TemperatureSeriesAnalysis temperatureSeriesAnalysis = new
                TemperatureSeriesAnalysis(new double[0]);
        temperatureSeriesAnalysis.average();
    ...
    public void testDeviation() {
        ...
        TemperatureSeriesAnalysis temperatureSeriesAnalysis = new
                TemperatureSeriesAnalysis(arg);
        double expecttedResult = 196.385335;
        double actualResult = temperatureSeriesAnalysis.deviation();
        assertEquals(expecttedResult, actualResult, 0.00001);
    }
    ...
    public void testFindTempClosestToZeroOnBiggestValues() {
        ...
        TemperatureSeriesAnalysis temperatureSeriesAnalysis = new
                TemperatureSeriesAnalysis(arg);
        double expectedResult = 1.2;
        double actualResult = temperatureSeriesAnalysis
                .findTempClosestToValue(1);
        assertEquals(expectedResult, actualResult, 0.00001);
    }
    ...
    public void testSummaryStatisticsAvgerageValue() {
        ...
        double actualResult = temperatureSeriesAnalysis.summaryStatistics()
                .getAvgTemp();
        assertEquals(expectedResult, actualResult, 0.000001);
    }
    ...
    @Test
    public void
    testAddTempsDoNotChangeNumberOfElementsWhenTryingToAddInappropriateTemps() {
        double[] arg1 = {1, 2};
        double[] arg2 = {1, 2, -274};
        TemperatureSeriesAnalysis temperatureSeriesAnalysis = new
                TemperatureSeriesAnalysis(arg1);
        try {
            temperatureSeriesAnalysis.addTemps(arg2);
        } catch (Exception ignored) {
        }
        double[] expectedResults = new double[]{1, 2};
        double[] actualResults = temperatureSeriesAnalysis
                .findTempsGreaterThen(-274);
    ...
    public void testAddTempsAfterAddTempsIgnoreEmptyPartOfArray() {
        ...
        double[] arg3 = {7};
        TemperatureSeriesAnalysis temperatureSeriesAnalysis = new
                TemperatureSeriesAnalysis(arg1);  // array size = 4,
        // elements in array = 4
        temperatureSeriesAnalysis.addTemps(arg2);   // array size = 8,
        // elements in array = 6, others - zero
        temperatureSeriesAnalysis.addTemps(arg3);   // array size = 8,
        // elements in array = 7, others - zero
